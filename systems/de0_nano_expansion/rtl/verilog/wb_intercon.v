...
module wb_intercon
   (input         wb_clk_i,
    ...
    output [31:0] wb_sdram_eth_adr_o,
    output [31:0] wb_sdram_eth_dat_o,
    output  [3:0] wb_sdram_eth_sel_o,
    output        wb_sdram_eth_we_o,
    output        wb_sdram_eth_cyc_o,
    output        wb_sdram_eth_stb_o,
    output  [2:0] wb_sdram_eth_cti_o,
    output  [1:0] wb_sdram_eth_bte_o,
    input  [31:0] wb_sdram_eth_dat_i,
    input         wb_sdram_eth_ack_i,
    input         wb_sdram_eth_err_i,
    input         wb_sdram_eth_rty_i,
...
wb_mux
  #(.num_slaves (10),
    .MATCH_ADDR ({32'h00000000, 32'h90000000, 32'h91000000, 32'h92000000, 32'ha0000000, 32'ha1000000, 32'hb0000000, 32'hb1000000, 32'hb2000000, 32'h92000000}),
    .MATCH_MASK ({32'hfe000000, 32'hffffffe0, 32'hfffffffe, 32'hfffffffe, 32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hfffffff8, 32'hffff0000}))
 wb_mux_dbus
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_sdram_dbus_adr_o, wb_m2s_resize_uart0_adr, wb_m2s_resize_gpio0_adr, wb_m2s_resize_gpio1_adr, wb_m2s_resize_i2c0_adr, wb_m2s_resize_i2c1_adr, wb_m2s_resize_spi0_adr, wb_m2s_resize_spi1_adr, wb_m2s_resize_spi2_adr, wb_eth0_adr_o}),
    .wbs_dat_o ({wb_sdram_dbus_dat_o, wb_m2s_resize_uart0_dat, wb_m2s_resize_gpio0_dat, wb_m2s_resize_gpio1_dat, wb_m2s_resize_i2c0_dat, wb_m2s_resize_i2c1_dat, wb_m2s_resize_spi0_dat, wb_m2s_resize_spi1_dat, wb_m2s_resize_spi2_dat, wb_eth0_dat_o}),
    .wbs_sel_o ({wb_sdram_dbus_sel_o, wb_m2s_resize_uart0_sel, wb_m2s_resize_gpio0_sel, wb_m2s_resize_gpio1_sel, wb_m2s_resize_i2c0_sel, wb_m2s_resize_i2c1_sel, wb_m2s_resize_spi0_sel, wb_m2s_resize_spi1_sel, wb_m2s_resize_spi2_sel, wb_eth0_sel_o}),
    .wbs_we_o  ({wb_sdram_dbus_we_o, wb_m2s_resize_uart0_we, wb_m2s_resize_gpio0_we, wb_m2s_resize_gpio1_we, wb_m2s_resize_i2c0_we, wb_m2s_resize_i2c1_we, wb_m2s_resize_spi0_we, wb_m2s_resize_spi1_we, wb_m2s_resize_spi2_we, wb_eth0_we_o}),
    .wbs_cyc_o ({wb_sdram_dbus_cyc_o, wb_m2s_resize_uart0_cyc, wb_m2s_resize_gpio0_cyc, wb_m2s_resize_gpio1_cyc, wb_m2s_resize_i2c0_cyc, wb_m2s_resize_i2c1_cyc, wb_m2s_resize_spi0_cyc, wb_m2s_resize_spi1_cyc, wb_m2s_resize_spi2_cyc, wb_eth0_cyc_o}),
    .wbs_stb_o ({wb_sdram_dbus_stb_o, wb_m2s_resize_uart0_stb, wb_m2s_resize_gpio0_stb, wb_m2s_resize_gpio1_stb, wb_m2s_resize_i2c0_stb, wb_m2s_resize_i2c1_stb, wb_m2s_resize_spi0_stb, wb_m2s_resize_spi1_stb, wb_m2s_resize_spi2_stb, wb_eth0_stb_o}),
    .wbs_cti_o ({wb_sdram_dbus_cti_o, wb_m2s_resize_uart0_cti, wb_m2s_resize_gpio0_cti, wb_m2s_resize_gpio1_cti, wb_m2s_resize_i2c0_cti, wb_m2s_resize_i2c1_cti, wb_m2s_resize_spi0_cti, wb_m2s_resize_spi1_cti, wb_m2s_resize_spi2_cti, wb_eth0_cti_o}),
    .wbs_bte_o ({wb_sdram_dbus_bte_o, wb_m2s_resize_uart0_bte, wb_m2s_resize_gpio0_bte, wb_m2s_resize_gpio1_bte, wb_m2s_resize_i2c0_bte, wb_m2s_resize_i2c1_bte, wb_m2s_resize_spi0_bte, wb_m2s_resize_spi1_bte, wb_m2s_resize_spi2_bte, wb_eth0_bte_o}),
    .wbs_dat_i ({wb_sdram_dbus_dat_i, wb_s2m_resize_uart0_dat, wb_s2m_resize_gpio0_dat, wb_s2m_resize_gpio1_dat, wb_s2m_resize_i2c0_dat, wb_s2m_resize_i2c1_dat, wb_s2m_resize_spi0_dat, wb_s2m_resize_spi1_dat, wb_s2m_resize_spi2_dat, wb_eth0_dat_i}),
    .wbs_ack_i ({wb_sdram_dbus_ack_i, wb_s2m_resize_uart0_ack, wb_s2m_resize_gpio0_ack, wb_s2m_resize_gpio1_ack, wb_s2m_resize_i2c0_ack, wb_s2m_resize_i2c1_ack, wb_s2m_resize_spi0_ack, wb_s2m_resize_spi1_ack, wb_s2m_resize_spi2_ack, wb_eth0_ack_i}),
    .wbs_err_i ({wb_sdram_dbus_err_i, wb_s2m_resize_uart0_err, wb_s2m_resize_gpio0_err, wb_s2m_resize_gpio1_err, wb_s2m_resize_i2c0_err, wb_s2m_resize_i2c1_err, wb_s2m_resize_spi0_err, wb_s2m_resize_spi1_err, wb_s2m_resize_spi2_err, wb_eth0_err_i}),
    .wbs_rty_i ({wb_sdram_dbus_rty_i, wb_s2m_resize_uart0_rty, wb_s2m_resize_gpio0_rty, wb_s2m_resize_gpio1_rty, wb_s2m_resize_i2c0_rty, wb_s2m_resize_i2c1_rty, wb_s2m_resize_spi0_rty, wb_s2m_resize_spi1_rty, wb_s2m_resize_spi2_rty, wb_eth0_rty_i}));
...
wb_mux
 ...
 wb_mux_eth0_master
   (.wb_clk_i  (wb_clk_i),
    ...
    .wbs_adr_o ({wb_sdram_eth_adr_o}),
    .wbs_dat_o ({wb_sdram_eth_dat_o}),
    .wbs_sel_o ({wb_sdram_eth_sel_o}),
    .wbs_we_o  ({wb_sdram_eth_we_o}),
    .wbs_cyc_o ({wb_sdram_eth_cyc_o}),
    .wbs_stb_o ({wb_sdram_eth_stb_o}),
    .wbs_cti_o ({wb_sdram_eth_cti_o}),
    .wbs_bte_o ({wb_sdram_eth_bte_o}),
    .wbs_dat_i ({wb_sdram_eth_dat_i}),
    .wbs_ack_i ({wb_sdram_eth_ack_i}),
    .wbs_err_i ({wb_sdram_eth_err_i}),
    .wbs_rty_i ({wb_sdram_eth_rty_i}));
