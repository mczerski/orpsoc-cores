...
set_location_assignment PIN_R9 -to eth0_col_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_col_pad_i
set_location_assignment PIN_T9 -to eth0_crs_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_crs_pad_i
set_location_assignment PIN_E15 -to eth0_rx_clk_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_clk_pad_i
set_location_assignment PIN_D15 -to eth0_rx_data_pad_i[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_data_pad_i[3]
set_location_assignment PIN_C15 -to eth0_rx_data_pad_i[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_data_pad_i[2]
set_location_assignment PIN_C14 -to eth0_rx_data_pad_i[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_data_pad_i[1]
set_location_assignment PIN_A14 -to eth0_rx_data_pad_i[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_data_pad_i[0]
set_location_assignment PIN_M16 -to eth0_rx_err_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_err_pad_i
set_location_assignment PIN_E16 -to eth0_rx_dv_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_rx_dv_pad_i
set_location_assignment PIN_C16 -to eth0_tx_clk_pad_i
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_clk_pad_i
set_location_assignment PIN_G15 -to eth0_tx_data_pad_o[3]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_data_pad_o[3]
set_location_assignment PIN_G16 -to eth0_tx_data_pad_o[2]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_data_pad_o[2]
set_location_assignment PIN_F16 -to eth0_tx_data_pad_o[1]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_data_pad_o[1]
set_location_assignment PIN_D14 -to eth0_tx_data_pad_o[0]
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_data_pad_o[0]
set_location_assignment PIN_D16 -to eth0_tx_en_pad_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_en_pad_o
set_location_assignment PIN_B16 -to eth0_tx_err_pad_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to eth0_tx_err_pad_o
